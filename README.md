...
This project was created for portfolio and learning purposes during my internship at ACA Group. The dashboard demonstrates my ability to clean data, build a data model, create Power BI reports, write DAX measures, and add Python forecasting to support business analysis.
